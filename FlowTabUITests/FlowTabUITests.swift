...
final class FlowTabUITests: XCTestCase {
    ...
    enum Identifier {
        ...
        static let homeHeader = "flowtab.home.header"
        ...
        static let homeWindowCount = "flowtab.home.window.count"
        static let homeStats = "flowtab.home.stats"
        static let homeStatsTotalApps = "flowtab.home.stats.total-apps"
        static let homeStatsVisibleApps = "flowtab.home.stats.visible-apps"
        static let homeStatsHiddenApps = "flowtab.home.stats.hidden-apps"
