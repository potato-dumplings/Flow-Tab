...
./scripts/testing/run-flowtabtests-local.sh \
  ...
  -only-testing:FlowTabTests/FlowTabPriorityCoverageTests/testSwitcherPanelControllerKeepsWindowLayerSnapshotWhenUnselectedWindowCloses \
  -only-testing:FlowTabTests/FlowTabPriorityCoverageTests/testSwitcherPanelControllerKeepsWindowLayerSnapshotWhenSelectedWindowCloses \
...
```bash
./scripts/testing/run-flowtabtests-local.sh \
  -only-testing:FlowTabTests/FlowTabPriorityCoverageTests/testLiveSwitcherModelKeepsWindowLayerSnapshotWhenCurrentAppProjectionRefreshes \
  -only-testing:FlowTabTests/FlowTabPriorityCoverageTests/testLiveSwitcherModelKeepsWindowLayerSnapshotWhenAppSwitcherProjectionRefreshes \
...
`RuntimeReadModelStore` projection-commit boundary, an active `windowCycle`
keeps its complete session snapshot across current-app and app-switcher projection commits, surface
...
./scripts/testing/run-ui-tests-local.sh \
  -only-testing:FlowTabUITests/FlowTabUITests/testSwitcherPanelKeepsOpenWindowLayerSnapshotAfterRealFixtureWindowSetMutation

./scripts/testing/run-ui-tests-local.sh \
  -only-testing:FlowTabUITests/FlowTabUITests/testSwitcherPanelKeepsWindowLayerWhenSelectedFixtureWindowCloses

./scripts/testing/run-ui-tests-local.sh \
  -only-testing:FlowTabUITests/FlowTabUITests/testSwitcherPanelKeepsOpenWorkflowAppWindowLayerSnapshotAfterMultiAppWindowSetMutation
