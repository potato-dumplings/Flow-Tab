...
- Broader multi-display/fullscreen topology and system-authoritative fullscreen
  ...
  source audit for Switcher fullscreen presentation reading only runtime Space
  topology projection, but that audit is not a replacement for real topology
  breadth proof.
