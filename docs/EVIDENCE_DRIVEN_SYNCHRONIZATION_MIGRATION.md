...
- Diagnostics and Process/Tooling: all three affected Swift sources parse
  ...
  `.build-local/evidence-driven-sync/SYNC-036BK` for exact post-commit cleanup.
- Commit: pending
