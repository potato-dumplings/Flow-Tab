...
- Diagnostics and Process/Tooling: both affected Swift sources parse directly
  ...
  reference edits remain unchanged and outside this slice. Rebuildable result
  bundle, DerivedData, caches, and logs occupy 705 MB under
  `.build-local/evidence-driven-sync/SYNC-036BJ` for exact post-commit cleanup.
- Commit: pending
