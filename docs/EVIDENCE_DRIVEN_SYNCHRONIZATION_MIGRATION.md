...
- Diagnostics and Process/Tooling: the affected Swift source parses directly
  ...
  Skill/reference edits remain unchanged and outside this slice. Rebuildable
  result bundles, DerivedData, caches, and logs occupy 709 MB under
  `.build-local/evidence-driven-sync/SYNC-036BP` for exact post-commit cleanup.
- Commit: pending
