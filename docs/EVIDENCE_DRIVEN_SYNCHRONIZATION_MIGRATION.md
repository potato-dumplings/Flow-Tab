...
- Process/Tooling: all three affected Swift sources parse directly and
  ...
  and the three pre-existing local Skill/reference edits remain unchanged and
  outside this slice. Rebuildable result bundle, DerivedData, fixture variants,
  caches, attachments, and logs occupy 804 MB under
  `.build-local/evidence-driven-sync/SYNC-036BD` for exact post-commit cleanup.
- Commit: pending
