...
| SYNC-032D | Preview publication and reveal routing boundary | Semantic caller review found that model preview-batch publication and controller-owned initial panel reveal have independent event sources and lifecycles. Migration routing. | Close model publication through SYNC-032D1 and controller reveal through SYNC-032D2. | M aggregate; child rows define required validation. | in progress: SYNC-032D1 completed |
