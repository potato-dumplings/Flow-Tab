...
- Treat UI/E2E evidence as strong when the test exercises the resulting runtime or visible behavior; persistence-only evidence contributes to its owning layer.
